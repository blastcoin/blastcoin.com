 ...
 */
function Blastcoin_html_head_alter(&$head_elements)
{
 ...
 */
function Blastcoin_css_alter(&$css)
{
...
function Blastcoin_form_alter(&$form, &$form_state, $form_id)
{
...
function Blastcoin_menu_item_link($link)
{
 ...
 */
function Blastcoin_preprocess_page(&$vars)
{
    ...
    // Chcek if is first setup of Blastcoin and install banners.
    if (variable_get('theme_Blastcoin_first_install', TRUE)) {
        include_once('theme-settings.php');
        _Blastcoin_install();
    }
    //to print the banners
    $banners        = Blastcoin_show_banners();
    $vars['banner'] = $banners;
}
/**
 * Duplicate of theme_menu_local_tasks() but adds clearfix to tabs.
 */
function Blastcoin_menu_local_tasks(&$variables)
{
    $output = '';
 ...
 */
function Blastcoin_preprocess_node(&$variables)
{
    $node = $variables['node'];
...
function Blastcoin_page_alter($page)
{
 ...
 */
function Blastcoin_show_banners()
{
    $banners        = Blastcoin_get_banners(FALSE);
    $slideshowSpeed = check_plain(theme_get_setting('slideshowSpeed', 'Blastcoin'));
    $slideshowEffect = check_plain(theme_get_setting('slideshowEffect', 'Blastcoin'));
	$backgroundButtonText = check_plain(theme_get_setting('backgroundButtonText', 'Blastcoin'));
 ...
 */
function Blastcoin_get_banners($all = TRUE)
{
    // Get all banners
    $banners       = variable_get('theme_Blastcoin_banner_settings', array());
 ...
 *    Settings to save
 */
function Blastcoin_set_banners($value)
{
    variable_set('theme_Blastcoin_banner_settings', $value);
}
/**
 ...
 *
 */
drupal_add_css(drupal_get_path('theme','Blastcoin').'/css/'.theme_get_setting('colors', 'Blastcoin'));
/**
 * Theme Homepage style
 *
 */
drupal_add_css(drupal_get_path('theme','Blastcoin').'/css/'.theme_get_setting('homepage', 'Blastcoin'));
...
if($lang_name == "ar" || $lang_name == "he"){
	drupal_add_css(drupal_get_path('theme','Blastcoin').'/css/style-rtl.css');
}else{
	drupal_add_css(drupal_get_path('theme','Blastcoin').'/css/style-rtl-off.css');
}
