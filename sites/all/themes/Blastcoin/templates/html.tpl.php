...
<!--[if lt IE 9]><script src="<?php print base_path() . drupal_get_path('theme', 'Blastcoin') . '/js/html5.js'; ?>"></script><![endif]-->
...
<?php if (theme_get_setting('backgroundPattern', 'Blastcoin')): ?>
...
<?php if (theme_get_setting('backgroundControls', 'Blastcoin')): ?>
<!-- Slideshow controls -->
<div class="fade">
