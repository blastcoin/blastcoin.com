  ...
  $.fn.bgimgSlideshow = function(options) {
   ...
   var fullscreen = true;
    ...
    $.bgimgSlideshow.stopSlideshow = function() {
      ...
      $("#control").css({ "background-image" : "url("+Drupal.settings.basePath+"sites/all/themes/Blastcoin/images/play.png)" });
    	// Clear the interval
    ...
    $.bgimgSlideshow.startSlideshow = function() {
      $("#control").css({ "background-image" : "url("+Drupal.settings.basePath+"sites/all/themes/Blastcoin/images/pause.png)" });
    	$.bgimgSlideshow.navigate("next");
	...
	$("#fullscreen").css({ "background-image" : "url("+Drupal.settings.basePath+"sites/all/themes/Blastcoin/images/fullscreen.png)" });
	...
	$("#fullscreen").click(function(){ 
	   ...
	   $.bgimgSlideshow.fullScreen = function() {
		...
		fullscreen = false;
	   $("#fullscreen").css({ "background-image" : "url("+Drupal.settings.basePath+"sites/all/themes/Blastcoin/images/fullscreen-exit.png)" });
	};
