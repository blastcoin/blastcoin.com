...
(function($) {
  ...
  $.fn.bgimgSlideshow = function(options) {
    ...
    $.bgimgSlideshow.stopSlideshow = function() {
      ...
      $("#control").css({ "background-image" : "url(sites/all/themes/Blastcoin/images/play.png)" });
    	// Clear the interval
    ...
    $.bgimgSlideshow.startSlideshow = function() {
      $("#control").css({ "background-image" : "url(sites/all/themes/Blastcoin/images/pause.png)" });
    	$.bgimgSlideshow.navigate("next");
